...
| Env var | Scope |
|---------|-------|
| `MOBILEBUILD_MCP_TEMPLATE_VERSION` | Shared fallback for both templates. |
| `MOBILEBUILD_MCP_IOS_TEMPLATE_VERSION` | iOS template only. |
| `MOBILEBUILD_MCP_MACOS_TEMPLATE_VERSION` | macOS template only. |
